    ...
    public class ReservationService : IReservationService
    {
        ...
        public async Task<ReservationDto> CreateAsync(string userId, ReservationCreateDto dto)
        {
            ...
            return new ReservationDto
            {
                ...
                HotelName = chambre.Hotel?.Name ?? "",   // ← ajouté
                HotelImageUrl = chambre.Hotel?.ImageUrl,          // ← ajouté
        ...
        public async Task<List<ReservationDto>> GetUserReservationsAsync(string userId)
        {
            return await _context.Reservations
                ...
                .Select(r => new ReservationDto
                {
                    ...
                    HotelName = r.Chambre.Hotel.Name,       // ← ajouté
                    HotelImageUrl = r.Chambre.Hotel.ImageUrl,   // ← ajouté
                    CheckIn = r.CheckIn,
                    CheckOut = r.CheckOut,
