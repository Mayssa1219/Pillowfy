...
{
    [DbContext(typeof(PilloWfyDbContext))]
    [Migration("20260508205634_AddPaiementEtAvis")]
    partial class AddPaiementEtAvis
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Pillowfy.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pillowfy.Models.Paiement", b =>
                {
                    b.HasOne("Pillowfy.Models.Reservation", "Reservation")
                        .WithOne()
                        .HasForeignKey("Pillowfy.Models.Paiement", "ReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
